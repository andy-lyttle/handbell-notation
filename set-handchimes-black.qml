...
MuseScore {
      version:  "1.0"
      description: qsTr("Sets the selected notes to use black diamond noteheads. Does not affect playback.")
      menuPath: "Plugins.Handbell Notation.Set Selected Notes to Handchimes (black)" // Ignored in MuseScore 4

      // These special comments are parsed by MuseScore 4.4, but ignored by older versions:
      //4.4 title: "Set Selected Notes to Handchimes (black)"
      //4.4 thumbnailName: "set-handchimes-black.png"
      //4.4 categoryCode: "composing-arranging-tools"
      
      // The same thing for MuseScore 4.0-4.3, ignored by 4.4:
      Component.onCompleted: {
            if (mscoreMajorVersion == 4 && mscoreMinorVersion <= 3) {
                  title = "Set Selected Notes to Handchimes (black)";
                  thumbnailName = "set-handchimes-black.png";
